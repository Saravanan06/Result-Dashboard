...
<body>
	...
	<center>
		...
		<br>
		<br>
		<form action="deleteRecord" onsubmit="return check()" method="post">
			<strong>Enter Rollno</strong> : <input type="text" name="rollno" id="del" required><br><br><br>
			<br> <input id="back" type="submit" id="back" value="Delete">&emsp;<input id="back" type="button" value="Back" onclick="history.back()">
		</form>
		</div>
	</center>
	<br><br><br><br>
	...
	%>
	<script>
		var inputs=document.getElementById("del")
